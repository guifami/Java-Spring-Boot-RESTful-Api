...
public class PersonController {
	...
	public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findPersonsByName(
		...
		Pageable pageable = PageRequest.of(page, size, Sort.by(sortDirection, "firstName"));
		return ResponseEntity.ok(_personService.findPersonsByName(firstName, pageable));
	}
	...
	@PutMapping(consumes = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML}, 
				produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML})
	@Operation(summary = "Updates a Person", description = "Updated", tags = {"People"},
	responses = {
		@ApiResponse(description = "Success", responseCode = "200", 
			content = @Content(schema = @Schema(implementation = PersonVO.class))
		),
	...
	public PersonVO disablePerson(@PathVariable(value = "id") Long id){
		return _personService.disablePerson(id);
	}
