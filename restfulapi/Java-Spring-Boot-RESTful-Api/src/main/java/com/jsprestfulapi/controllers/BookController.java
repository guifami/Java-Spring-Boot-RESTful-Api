...
import com.jsprestfulapi.services.BookServices;
...
public class BookController {
	...
	@Operation(summary = "Finds all Books", description = "Finds all Book", tags = {"Book"},
				responses = {
	...
	public ResponseEntity<PagedModel<EntityModel<BookVO>>> findAll(
		...
		return ResponseEntity.ok(_bookService.findAll(pageable));
	}
	...
	@PutMapping(consumes = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML}, 
				produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML})
	@Operation(summary = "Updates a Book", description = "Updated", tags = {"Book"},
	responses = {
		@ApiResponse(description = "Success", responseCode = "200", 
			content = @Content(schema = @Schema(implementation = BookVO.class))
		),
	...
	@Operation(summary = "Deletes a Book", description = "Deleted", tags = {"Book"},
	responses = {
		@ApiResponse(description = "No Content", responseCode = "204", content = @Content),
		@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
		@ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
